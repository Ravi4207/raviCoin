...
contract RAVI{
    ...
    function stakeInvestment() payable public returns (uint256 liquidityAmount, uint256 stakeTokens){
        ...
        require(liquidityAmount > 0, "RAVI : Reserve amount zero");
        require(stakeTokens > 0, "RAVI : Token amount zero");
        
        RAVI.transfer(msg.sender,stakeTokens);
    }
